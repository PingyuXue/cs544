...
public class ChatClient5 {
    ...
    5. left delay accept:   180- 100 - 36 = 44 msec


     */
    private String host = "localhost";// 连接到本机
    private int port = 8205;// 8205 , slice 5



    private int count = 1;
    public static String prefix = "/Users/Gaffe_D/Desktop/cs544_pro/audio_2/test2_animal/5/";
    ...
    private static int fileSlice = 5;
    ...
    // connect  to the server 5
    public ChatClient5(String host, int port) {
        this.host = host;
        this.port = port;
    }
...
//                        }
                        ...
                        // step 1: get the data
                        InterLeavingPckg [] interLeavingPckgs = new InterLeavingPckg[5];
                        ...
                        interLeavingPckgs[4] = ( InterLeavingPckg) getFromServe5;
...
//                            long DelayofDjitter;
                            if ( happendRate >= 5){
                                ...
                                pckNumber = randomGetter.getRandomPackage()+ (int)Math.random();
                            }
...
//                            }
                        ...
                        {
                            for ( int i = 0; i < 5; i++){
                                System.out.println("check array length: i is "+ i + " size is :"+ interLeavingPckgs[i].interleavingSet.size());
...
//                                        }
                                ...
                                if ( j == 3) {
                                    ...
                                    System.out.println("set 3 in");
                                    if (count == -1){
                                        set4.add(interLeavingPckgs[i].interleavingSet.get(1));
                                    }
                                    else {
                                ...
                                if ( j == 4) {
                                    ...
                                    System.out.println("set 3 in");
                                    if (count == -1){
                                        set5.add(interLeavingPckgs[i].interleavingSet.get(1));
                                    }
                                    else {
                                        set5.add(interLeavingPckgs[i].interleavingSet.get(j));
                                    }
                                }
                            }
                        ...
                        pckgArray = new InterLeavingPckg[5];
                        ...
                        pckgArray[4] = new InterLeavingPckg(set5);
